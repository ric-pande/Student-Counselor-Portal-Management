...
<center><table>
	<tr><td><b><font size=6 color=white>Absence details:</font></b></td></tr>
	<tr><td><br></td></tr>
	</table></center>     
...
$result3=$conn->query("select * from counsellor.absence");
	...
	if(!(strcmp($row1["user_name"],$_SESSION["name1"])))
	{
		while($row2=$result2->fetch_array(MYSQLI_ASSOC))
		{
            ...
            <tr>
                ...
                <td width="10%" ></center><?php echo $row3["start"]; ?><center></td>
                <td width="10%" height="10%"></center><?php echo $row3["end"]; ?><center></td>
                <td width="10%" height="10%"></center><?php echo $row3["reason"]; ?><center></td>
            </tr>
