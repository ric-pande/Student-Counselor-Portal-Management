...
<center>
	...
	<br>
	<br>
	<tr><td><b><font size=6 color=white>HSS details  </font></b></td>
	<?php
...
$result2=$conn->query("select * from counsellor.hss");
	...
	if(!(strcmp($row1["usn"],$usn)))
	{
		while($row2=$result2->fetch_array(MYSQLI_ASSOC))
		{
            ...
            <tr>
                ...
                <td width="10%" height="10%"><center><?php echo $row2["event"]; ?></center></td>
                <td width="10%" height="10%"><center><?php echo $row2["start"]; ?></center></td>
                <td width="10%" height="10%"><center><?php echo $row2["end"]; ?></center></td>
                <td width="10%" height="10%"><center><?php echo $row2["category"]; ?></center></td>
            </tr>
