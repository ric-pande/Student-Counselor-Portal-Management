...
<center>
      <form method="post" action="temp1.php" >
					<table>
					<tr><td style="color:white"><B><font size=7.5> Counsellor Login</font></B></td></tr>
					<tr><td><br></td></tr>
					<tr><td><br></td></tr>
					<tr><td><br></td></tr>
					<tr><td><font color="white" size=5.8>User Name:</font></td><td><input type="text" name="name" required="required"/></td></tr>
								<tr><td><br></td></tr>
