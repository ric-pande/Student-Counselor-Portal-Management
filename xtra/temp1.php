...
echo $pass1;echo
$sql = "(select * from counsellor.staff where user_name='{$_POST['name']}' and pwd=md5('$pass'))";
...
//{ echo $row["user_name"];
	...
	if($flag==0)
	{
		...
		?>
		<br>
		<a href="coun_login.php">BACK TO LOGIN PAGE</a>
		</center>
		<?php
	}
//}
...
if ($flag) header("Location: counsellor_view.php");
